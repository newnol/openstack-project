...
Ngô Tấn Tài (23127470) & Trưởng nhóm & Quản trị máy chủ Proxmox/DevStack, thiết lập VPN NetBird, thực thi Module 1 (Khảo sát dịch vụ cốt lõi Nova/Glance/Neutron trên Horizon \& CLI) và quản lý tài nguyên chung. & 100\% \\ \hline
Nguyễn Tấn Lộc (23127406) & Thành viên & Thiết kế mạng phân tầng SDN Module 2 (DMZ/Private, Router L3), triển khai máy ảo Dual-NIC Module 3, cấu hình định tuyến kernel xử lý Asymmetric Routing và ánh xạ Floating IP. & 100\% \\ \hline
Hồ Minh Dũng (23127174) & Thành viên & Triển khai lưu trữ Swift \& Cinder Module 4, thực nghiệm phục hồi thảm họa với Snapshot; xây dựng mẫu Heat HOT \& Cloud-Init tự động hóa Module 5; tổng hợp kiểm thử toàn trình và biên soạn báo cáo. & 100\% \\ \hline
\end{tabularx}
